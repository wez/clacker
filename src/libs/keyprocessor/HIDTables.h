...
#define HID_CONSUMER_AL_REMOTE_NETWORKING_SLASH_ISP_CONNECT \
  0x197 // HID type SEL
...
#define HID_CONSUMER_AL_PREEMPTIVE_HALT_TASK_SLASH_APPLICATION \
  0x1A5 // HID type SEL
...
#define HID_CONSUMER_AL_MARKET_MONITOR_SLASH_FINANCE_BROWSER \
  0x1C3 // HID type SEL
